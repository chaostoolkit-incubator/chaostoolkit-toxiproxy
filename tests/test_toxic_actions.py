...
class TestActionMethods (unittest.TestCase):
    ...
    def test_create_latency_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_latency_toxic(for_proxy="foobar", toxic_name="toxic1", latency=1000, configuration=mockconfig))
    ...
    def test_create_latency_toxic_with_jitter(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_latency_toxic(for_proxy="foobar", toxic_name="jittery", latency=1000, jitter=300, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
    ...
    def test_create_bandwith_degradation_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_bandwith_degradation_toxic(for_proxy="foobar", toxic_name="bandwidth", rate=400, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
    ...
    def test_create_slow_connection_close_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_slow_connection_close_toxic(for_proxy="foobar", toxic_name="slowy", delay=900, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
    ...
    def test_create_timeout_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_timeout_toxic(for_proxy="foobar", toxic_name="timy", timeout=6900, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
    ...
    def test_create_slicer_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_slicer_toxic(for_proxy="foobar", toxic_name="hamslice", average_size=6900, size_variation=20, delay=20, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
    ...
    def test_create_limiter_toxic(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(actions.create_limiter_toxic(for_proxy="foobar", toxic_name="limiteless", bytes_limit=100, configuration=mockconfig))
        toxiproxyapi_mock.assert_called_once_with(proxy_name="foobar", toxic_json=request_json, configuration=mockconfig)
