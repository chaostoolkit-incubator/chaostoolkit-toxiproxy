...
class TestProbesMethods(unittest.TestCase):
    ...
    def test_proxy_exist_success(self, toxiproxyapi_mock, mockconfig):
        ...
        self.assertTrue(
            probes.proxy_exist(proxy_name="testproxy", configuration=mockconfig)
        )
    ...
    def test_get_proxy_attribute(self, toxiproxyapi_mock, mockconfig):
        ...
        ret_attribute = probes.get_proxy_attribute(
            proxy_name="testproxy", attribute="listen", configuration=mockconfig
        )
